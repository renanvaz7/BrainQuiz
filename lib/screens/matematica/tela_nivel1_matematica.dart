...
class MatematicaNivel1 extends StatefulWidget {
  MatematicaNivel1({Key? key}) : super(key: key);

  @override
  _MatematicaNivel1State createState() => _MatematicaNivel1State();
}

class _MatematicaNivel1State extends State<MatematicaNivel1> {
  @override
